...
func ComparePassword(passwordNew, hashPassword string) bool {
	match, err := comparePasswordAndHash(passwordNew, hashPassword)
	if err != nil {
		log.Println(err)
	}
...
func ReturnError(msg, msgUser string) entities.ServerError {
